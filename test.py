...
response = requests.post("https://push.bigtincan.com/v5/webapi/signin", data)
data = response.json()
print(data)
...
tabs = requests.get(
    ...
    params={"limit": 100, "offset": 0, "sort_by": "name", "show_hidden_channels": 0},
    headers=headers,
)
tabs = tabs.json()
print(tabs)
...
for tab in tabs:
    ...
    channels_request = requests.get(
        "https://push.bigtincan.com/v5/webapi/content/channels?tab_id={}".format(
            tab_id
        ),
        headers=headers,
    )
    ...
    for channel in channels:
        ...
        stories_request = requests.get(
            "https://push.bigtincan.com/v5/webapi/content/stories?channel_id={}".format(
                channel_id
            ),
            headers=headers,
        )
